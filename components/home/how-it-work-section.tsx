...
const steps: Step[] = [
  {
    ...
    description: 'Simply drag and drop your PDF document or clik to upload',
  },
  {
    ...
    >
      <div className='py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 '>
        ...
        <div className='text-center mb-16'>
          <h3 className='font-bold text-xl uppercase mb-4 text-rose-500'>
            How it works
          </h3>
          <h3 className='font-bold text-3xl max-2-2xl mx-auto'>
...
function StepItem({ icon, label, description }: Step) {
  return (
    <div className='relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/10 transition-colors group w-full'>
