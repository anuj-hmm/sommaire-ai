...
const PricingCard = ({ name, price, description, items, id, paymentLink }:PriceType) => {
  return (
    <div className='relative w-full max-w-lg hover:scale-105 hover:trasition-all duration-300'>
      ...
      <div className='space-y-2 flex justify-center w-full '>
        <Link href={paymentLink} className={cn('w-full rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-rose-800 to-rose-500 hover:to-rose-800 text-white border-2 py-2',
